...
export const componentsQuestions: Omit<Question, 'id'>[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Да, можно использовать оба типа компонентов в одном приложении, хотя функциональные компоненты предпочтительнее.',
    category: 'Компоненты',
    difficulty: 'Легкий',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Чистая функция (компонент) возвращает одинаковый результат для одинаковых входных данных и не имеет побочных эффектов.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'children - это специальный prop, который содержит дочерние элементы, переданные в компонент.',
    category: 'Компоненты',
    difficulty: 'Легкий',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Children передаются между открывающим и закрывающим тегами компонента: <Component>children</Component>.',
    category: 'Компоненты',
    difficulty: 'Легкий',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Render props - это паттерн где компонент получает функцию через prop и использует её для динамического рендеринга части UI.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Computed props можно создать вычисляя значения на основе входящих props внутри компонента.',
    category: 'Компоненты',
    difficulty: 'Средний',
    tags: ['компоненты', 'props'],
    type: 'single',
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Prop drilling можно избежать используя Context API или библиотеки управления глобальным состоянием.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Compound компонент - это паттерн где группа компонентов работает вместе через неявное разделение состояния.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Presentation компонент (dumb/stateless) получает данные и обратные вызовы через props, не содержит бизнес-логику.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Container компонент (smart/stateful) управляет данными и содержит бизнес-логику, передает данные presentation компонентам.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'React.memo следует использовать когда компонент часто рендерится с неизменяющимися props для оптимизации производительности.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'forwardRef позволяет компоненту получить ref от родителя и передать его дальше дочернему DOM элементу или компоненту.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'useImperativeHandle позволяет определить значение экземпляра, которое может быть доступно родительским компонентам при использовании ref.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Context позволяет передавать данные через дерево компонентов без явной передачи props на каждом уровне.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Lifecycle методы (componentDidMount, componentDidUpdate, etc.) вызываются React в разные моменты жизненного цикла компонента.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Основные lifecycle методы: componentDidMount, componentDidUpdate, componentWillUnmount, и несколько других.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'componentDidMount вызывается после того как компонент смонтирован (отрендерен) в DOM дерево.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'componentDidUpdate вызывается сразу после обновления компонента (но не после первого рендера).',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'componentWillUnmount вызывается непосредственно перед размонтированием и удалением компонента из DOM.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Error boundaries - это специальные компоненты, которые перехватывают JavaScript ошибки в любом месте дерева дочерних компонентов.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Error boundaries отлавливают ошибки рендеринга, lifecycle методов и конструкторов компонентов в их дереве.',
    category: 'Компоненты',
    difficulty: 'Сложный',
    tags: ['компоненты', 'error-boundaries'],
    type: 'single',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Error boundaries не отлавливают ошибки в event handlers, асинхронном коде и при серверном рендеринге.',
    category: 'Компоненты',
    difficulty: 'Сложный',
    tags: ['компоненты', 'error-boundaries'],
    type: 'single',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Suspense boundary позволяет показывать fallback UI пока дочерние компоненты загружаются или рендерятся асинхронно.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Smart (container) компоненты управляют состоянием и логикой, dumb (presentation) компоненты отображают UI.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Uncontrolled input - это элемент формы, значение которого хранится в DOM, а не управляется React state.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Controlled input - это элемент формы, значение которого контролируется React через state и onChange handler.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Compound компонент - это группа компонентов работающих вместе для создания сложной функциональности.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation: 'React компоненты поддерживают вложенность, могут возвращать null и массивы элементов.',
    category: 'Компоненты',
    difficulty: 'Средний',
    tags: ['компоненты'],
    type: 'single',
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Компонент может вернуть несколько элементов используя Fragment или массив, но обычно рекомендуется возвращать один элемент.',
    category: 'Компоненты',
    difficulty: 'Средний',
    tags: ['компоненты', 'jsx'],
    type: 'single',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Данные передаются от родителя к ребенку через props.',
    category: 'Компоненты',
    difficulty: 'Легкий',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Обратные вызовы передаются через props как функции.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'React выдаст предупреждение, так как props являются неизменяемыми (immutable).',
    category: 'Компоненты',
    difficulty: 'Средний',
    tags: ['компоненты', 'props'],
    type: 'single',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Key prop помогает React идентифицировать элементы в списке для эффективного обновления.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation: 'Index можно использовать только если список статичен. Для динамических списков нужны уникальные ключи.',
    category: 'Компоненты',
    difficulty: 'Средний',
    tags: ['компоненты', 'keys'],
    type: 'single',
  },
  {
    ...
    correctAnswer: 3,
    explanation: 'Composition обеспечивает модульность, переиспользуемость, простоту тестирования и улучшает читаемость кода.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: 'Shadow DOM это браузерная технология для инкапсуляции. React использует Virtual DOM, не Shadow DOM.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation: 'PropTypes служат для документации, проверки типов и обнаружения потенциальных ошибок во время разработки.',
    category: 'Компоненты',
    difficulty: 'Средний',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'isRequired указывает что prop является обязательным и React выдаст предупреждение если prop не передан.',
    category: 'Компоненты',
    difficulty: 'Средний',
    tags: ['компоненты', 'prop-types'],
    type: 'single',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'cloneElement клонирует React элемент и позволяет передать ему новые props.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'isValidElement проверяет является ли переданный объект валидным React элементом.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'React.Children предоставляет утилиты для работы с children: map, forEach, count, toArray, only.',
    category: 'Компоненты',
    difficulty: 'Сложный',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Имена React компонентов должны начинаться с заглавной буквы, чтобы отличаться от обычных HTML элементов.',
    category: 'Компоненты',
    difficulty: 'Легкий',
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Custom hooks позволяют извлечь логику компонента в переиспользуемую функцию с доступом к hooks.',
    category: 'Компоненты',
    difficulty: 'Средний',
